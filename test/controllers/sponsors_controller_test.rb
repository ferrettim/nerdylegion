...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { description: @sponsor.description, image: @sponsor.image, link: @sponsor.link, name: @sponsor.name, status: @sponsor.status } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { description: @sponsor.description, image: @sponsor.image, link: @sponsor.link, name: @sponsor.name, status: @sponsor.status } }
