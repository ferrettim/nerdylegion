...
class PrivaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create privacy" do
    assert_difference('Privacy.count') do
      post privacies_url, params: { privacy: { description: @privacy.description, title: @privacy.title } }
    end
  ...
  test "should update privacy" do
    patch privacy_url(@privacy), params: { privacy: { description: @privacy.description, title: @privacy.title } }
